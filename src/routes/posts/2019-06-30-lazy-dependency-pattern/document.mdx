...
<Tldr>
  Run creact-react-blog, build with Gatsby and deploy on Netlify. Personalise your blog and add comments using utteranc.es.
</Tldr>

## The way that the Lazy Dependency pattern works
